...
gitaly-setup: gitaly/_build/bin/gitaly gitaly/_build/deps/git/install/bin/git gitaly/gitaly.config.toml gitaly/praefect.config.toml
...
.PHONY: gitaly/_build/bin/gitaly
gitaly/_build/bin/gitaly: ${gitaly_clone_dir}/.git
	@echo
	@echo "${DIVIDER}"
