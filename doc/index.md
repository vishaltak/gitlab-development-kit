...
GitLab Development Kit (GDK) provides a local environment for developing GitLab and related
projects.
...
Before [setting up GDK](#install-and-setup-gdk), your local environment must have prerequisite
third-party software installed and configured. Some dependencies can be installed with a
"package manager".
...
[Advanced instructions](advanced.md) are also available, including instructions for:
