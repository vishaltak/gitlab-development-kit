...
| Terminal       | <p>Make sure to close and reopen the Terminal after installing a Ruby version manager to make sure it is activated.</p><p>You can check the active version with the command `ruby --version`.</p><hr><p>How to install `rbenv` on MacOS - [Guide](https://gitlab.com/snippets/1893737) </p>                                                                                                                                                                         |
