...
| Google Chrome  | [Google Chrome](https://www.google.com/chrome/) and [ChromeDriver](https://sites.google.com/a/chromium.org/chromedriver/downloads) version 60 or greater. Visit the Chrome Driver [Getting started](https://chromedriver.chromium.org/getting-started) page for more details. _Note: This is included via `brew` in the Mac installation._                                                          |
...
_**Note:** you may have to close and reopen the Terminal after installing a Ruby 
version manager to read new PATH variables added for Ruby executable files._
