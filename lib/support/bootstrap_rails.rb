...
module Support
  class BootstrapRails
    ...
    RAILS_RUNNER_SKIP_RUGGED_AUTO_DETECT_CMD = %w[support/exec-cd gitlab bundle exec rails runner Feature.enable(:skip_rugged_auto_detect)].freeze
    ...
    def set_feature_flags
      run_command(RAILS_RUNNER_SKIP_RUGGED_AUTO_DETECT_CMD)
    end
