...
tasks.add_template(name: 'gitlab/config/redis.yml', template: 'support/templates/gitlab/config/redis.yml.erb', erb_extra_args: { clusters: %i[cache repository_cache queues rate_limiting sessions shared_state trace_chunks] })
tasks.add_template(name: 'gitlab/config/resque.yml', template: 'support/templates/gitlab/config/resque.yml.erb', erb_extra_args: { cluster: :shared_state })
