...
const sourcePath = path.join('gitlab', 'node_modules', '@gitlab-org/gitlab-svgs', 'dist');
const sourcePathIllustrations = path.join('gitlab', 'node_modules', '@gitlab-org/gitlab-svgs', 'dist', 'illustrations');
const destPath = path.normalize(path.join('gitlab', 'app', 'assets', 'images'));
