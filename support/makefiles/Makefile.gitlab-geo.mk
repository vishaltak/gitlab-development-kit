...
geo-primary-migrate-run: ensure-data-services-running .gitlab-bundle gitlab-db-migrate gitlab/git-checkout-auto-generated-files diff-config

.PHONY: geo-primary-update
geo-primary-update: update geo-primary-migrate diff-config

.PHONY: geo-secondary-migrate
geo-secondary-migrate: ensure-data-services-running .gitlab-bundle gitlab-db-migrate gitlab/git-checkout-auto-generated-files
