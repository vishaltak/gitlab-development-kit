  ...
  module Danger
    module Roulette
      ...
      def spin(project, categories, timezone_experiment: false)
        ...
        default_spin = spins.find { |spin| spin.category == :default }
        ...
        spins.each do |spin|
          ...
          when :test
            ...
            if spin.reviewer.nil?
              ...
              spin.reviewer = default_spin&.reviewer || spin_for_category(project, :default, timezone_experiment: including_timezone).reviewer
            end
          when :engineering_productivity
            if spin.maintainer.nil?
              # Fetch an already picked backend maintainer, or pick one otherwise
              spin.maintainer = default_spin&.maintainer || spin_for_category(project, :default, timezone_experiment: including_timezone).maintainer
            end
          when :ci_template
            if spin.maintainer.nil?
              # Fetch an already picked backend maintainer, or pick one otherwise
